...
import Logo from 'D:/TaiLieuUet/web/BTL/magicpost_ver2/my-project/src/assets/img/logo_color.png'
      ...
      <nav className='bg-white md:px-4 p-4 w-full border-b mx-auto text-primary fixed right-0 top-0 left-0 shadow-md' >
        <div className='text-lg container mx-auto flex justify-between items-center font-[500]'>
          <div className='flex space-x-14 items-center'>
            <a href='/home' className='text-2xl font-semibold flex items-center text-primary'> 
              <img src={Logo} alt='' className='h-12 inline-block items-center'/> 
            </a>
          ...
          <div className='space-x-12 hidden md:flex items-center'>
            <a href='/' className='hidden lg:flex items-center hover:text-secondary'>Đăng ký</a>
            <button className='bg-secondary py-2 px-4 transition-all duration-300 rounded hover:text-white hover:bg-indigo-600'>Đăng nhập</button>
          </div>
